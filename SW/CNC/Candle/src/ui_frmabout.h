...
"}"));
    ...
    void retranslateUi(QDialog *frmAbout)
    {
        ...
        lblAbout->setText(QCoreApplication::translate("frmAbout", "<html><head/><body><p>Candle<br/>Version: %1<br/>License: GNU GENERAL PUBLIC LICENSE<br/>Visit: <a href=\"https://github.com/Denvi/Candle/\"><span style=\" text-decoration: underline; color:#0000ff;\">https://github.com/Denvi/Candle/<br/></span></a>\302\251 2015-2016 Hayrullin Denis Ravilevich</p></body></html>", nullptr));
